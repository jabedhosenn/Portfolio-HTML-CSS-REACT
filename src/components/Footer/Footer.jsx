    ...
    <div className='footer bg-dark section-p' id = "footer">
        <div className='container'>
            ...
            <div className='footer-content'>
                ...
                <p className='text-center fs-14 text-white op-07 fw-3 ls-1 reserved-text'>All Rights Reserved &copy; 2026</p>
                <p className='text-center fs-14 text-white op-07 fw-3 ls-1 reserved-text'>Developed by Jabed Hosen</p>
            </div>
        </div>
    </div>
  )
